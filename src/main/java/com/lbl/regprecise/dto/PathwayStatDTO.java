 ...
 */
@XmlRootElement
public class PathwayStatDTO {
	private int pathwayId;
	private String pathwayName;
	
	private  int pathwayClassId;
	private String pathwayClassName;
	...
	public int getPathwayClassId() {
		return pathwayClassId;
	}
	public void setPathwayClassId(int pathwayClassId) {
		this.pathwayClassId = pathwayClassId;
	}
	public String getPathwayClassName() {
		return pathwayClassName;
	}
	public void setPathwayClassName(String pathwayClassName) {
		this.pathwayClassName = pathwayClassName;
	}
